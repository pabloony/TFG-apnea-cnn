...
#SBATCH --error=tests/job_data/comprobaciones/diagnose_dataset.%J.err
#SBATCH --output=tests/job_data/comprobaciones/diagnose_dataset.%J.out
...
time python -m src.complementation.diagnose_dataset
